            ...
            <Toolbar disableGutters>
              ...
              <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                ...
                >
                  ...
                  {props.user && props.user.role !== 'Staff' && props.user.role !== "BillingAssociate" && props.user.role !== "Store Associate" && props.user.role !== "Senior Store Associate" && props.user.role !== "Billing Associate" && <MenuItem key={pages[2][0]} onClick={handleCloseNavMenu}>
                    <Typography textAlign="center"><Link className='nav-link' to={pages[2][1]}>{pages[2][0]}</Link> </Typography>
                  </MenuItem>}
                  {props.user && props.user.role !== 'Staff' && props.user.role !== "BillingAssociate" && props.user.role !== "Store Associate" && props.user.role !== "Senior Store Associate" && props.user.role !== "Billing Associate" && <MenuItem key={pages[3][0]} onClick={handleCloseNavMenu}>
              ...
              <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                ...
                {props.user && props.user.role !== 'Staff' && props.user.role !== "BillingAssociate" && props.user.role !== "Store Associate" && props.user.role !== "Senior Store Associate" && props.user.role !== "Billing Associate" && <Button
                  key={pages[2][0]}
                  onClick={handleCloseNavMenu}
                  sx={{ my: 2, color: 'white', display: 'block' }}
                >
